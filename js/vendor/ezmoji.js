...
ezmoji.list = {
    // People
    bowtie: { code: ':bowtie:', emoji: this.msg, available: false },
    smile: { code: ':smile:', emoji: '😄' },
    laughing: { code: ':laughing:', emoji: '😆' },
    blush: { code: ':blush:', emoji: '😊' },
    smiley: { code: ':smiley:', emoji: '😃' },
    relaxed: { code: ':relaxed:', emoji: this.msg, available: false },
    ...
    neckbeard: { code: ':neckbeard:', emoji: this.msg, available: false },
    ...
    bow: { code: ':bow:', emoji: '🙇' },
    couplekiss: { code: ':couplekiss:', emoji: this.msg },
    ...
    feelsgood: { code: ':feelsgood:', emoji: this.msg, available: false },
    finnadie: { code: ':finnadie:', emoji: this.msg, available: false },
    goberserk: { code: ':goberserk:', emoji: this.msg, available: false },
    godmode: { code: ':godmode:', emoji: this.msg, available: false },
    hurtrealbad: { code: ':hurtrealbad:', emoji: this.msg, available: false },
    rage1: { code: ':rage1:', emoji: this.msg, available: false },
    rage2: { code: ':rage2:', emoji: this.msg, available: false },
    rage3: { code: ':rage3:', emoji: this.msg, available: false },
    rage4: { code: ':rage4:', emoji: this.msg, available: false },
    suspect: { code: ':suspect:', emoji: this.msg, available: false },
    trollface: { code: ':trollface:', emoji: this.msg, available: false },
    ...
    octocat: { code: ':octocat:', emoji: this.msg, available: false },
    squirrel: { code: ':squirrel:', emoji: this.msg, available: false }  
};
...
ezmoji.initEmojisOnLoad = function() {
